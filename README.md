# Automated Arch Linux package for slack-desktop
...
[AUR entry][AUR slack-desktop]. AUR entries are just Git repositories.
...
[AUR slack-desktop]: https://aur.archlinux.org/packages/slack-desktop/
